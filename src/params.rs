...
impl HqcParams for Hqc128 {
    ...
    const N_WORDS: usize = (17_669 + 63) / 64;                       // 277
    const PK_BYTES: usize = 32 + (17_669 + 7) / 8;                   // 2_241
    const CT_BYTES: usize = (17_669 + 7) / 8 + (46 * 384 + 7) / 8 + 16; // 4_433
...
impl HqcParams for Hqc192 {
    ...
    const N_WORDS: usize = (35_851 + 63) / 64;                        // 561
    const PK_BYTES: usize = 32 + (35_851 + 7) / 8;                    // 4_514
    const CT_BYTES: usize = (35_851 + 7) / 8 + (56 * 640 + 7) / 8 + 16; // 8_978
    const SK_BYTES: usize = 32;
}
...
impl HqcParams for Hqc256 {
    ...
    const N_WORDS: usize = (57_637 + 63) / 64;                        // 901
    const PK_BYTES: usize = 32 + (57_637 + 7) / 8;                    // 7_237
